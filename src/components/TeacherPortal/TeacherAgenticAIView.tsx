...
const INITIAL_TEACHER_MESSAGES: ChatMessage[] = [
  {
    id: 'msg-1',
    sender: 'ai',
    text: `👨‍🏫 Welcome Professor! I am your **EduSync Teacher Agentic AI Co-Pilot**.
              ...
              >
                <div className="flex items-center justify-between gap-4 mb-1">
                  <span className={`font-mono text-[10px] font-bold ${isAI ? 'text-cyan-300' : 'text-blue-100'}`}>
                    {isAI ? 'Teacher Agentic AI' : 'Dr. Sanmitra (Faculty)'}
                  </span>
                  <div className="flex items-center gap-2">
