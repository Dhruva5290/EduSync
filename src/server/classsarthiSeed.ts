...
export const seedLectures: ClassSarthiLecture[] = [
  // =========================================================================
  ...
  // =========================================================================
  {
    ...
    duration: '45 mins',
    summary:
      'Foundational lecture on Newtonian kinetics: Definition of inertia, first law condition, rigorous formulation of free body diagrams on inclined planes, resolution of normal force, distinction between force and acceleration, and friction coupling.',
    topics: [
      "Newton's First Law",
    ...
    timeline: [
      {
        ...
        teacherQuote:
          'Good morning class. Today we transition from kinematics to kinetics—asking not just how objects move, but what fundamental physical interactions cause motion.',
        notes:
          'Kinematics described trajectory $s(t)$, velocity $v(t)$, and acceleration $a(t)$. Kinetics investigates the causes of acceleration—namely forces acting between bodies.',
      ...
      },
      {
        ...
        teacherQuote:
          "Newton's First Law states: Every body continues in its state of rest or uniform motion in a straight line unless compelled to change that state by an external net unbalanced force.",
        notes:
          "Equilibrium condition: $\\sum \\vec{F}_{ext} = 0 \\implies \\vec{a} = 0 \\implies \\vec{v} = \\text{constant}$. This defines the inertial frame of reference.",
      ...
      },
      {
        ...
        teacherQuote:
          'Inertia is the intrinsic property of matter to resist any change in its velocity. Mass $m$ is the quantitative scalar measure of inertia. When a metro train brakes suddenly, passengers jerk forward not because a forward force was applied, but because their upper bodies maintain forward velocity due to inertia.',
        notes:
          'Types of inertia: (1) Inertia of rest, (2) Inertia of motion, (3) Inertia of direction. In a non-inertial accelerating frame with acceleration $\\vec{a}_0$, a pseudo-force $\\vec{F}_{pseudo} = -m\\vec{a}_0$ must be introduced.',
      ...
      },
      {
        ...
        teacherQuote:
          'Here is a critical misconception students make every year: Force and acceleration are NOT the same quantity. Force is an interaction (cause, measured in Newtons); acceleration is the kinematic rate of change of velocity (effect, in $m/s^2$). Let us solve: Block of mass $5\\text{ kg}$ on a $30^\\circ$ ramp with kinetic friction coefficient $\\mu_k = 0.2$. $a = g(\\sin 30^\\circ - \\mu_k \\cos 30^\\circ) = 9.8(0.5 - 0.2 \\times 0.866) = 3.20\\text{ m/s}^2$.',
        notes:
      ...
      },
      {
        ...
        teacherQuote:
          'For your homework assignment: Solve problems 4 through 9 from Chapter 5 of HC Verma on connected pulley systems and friction blocks. Submit your work through the platform before Friday 5:00 PM.',
        notes:
    ...
    boardCaptures: [
      {
        ...
        explanation:
          'Blackboard capture illustrating coordinate tilt along inclined plane with normal reaction perpendicular to surface and gravity decomposed into orthogonal vectors.'
      },
      {
        id: 'bc-phy-2',
        lectureId: 'lec-phy-101',
        ...
        explanation:
          'Step-by-step mathematical board work resolving two-block friction constraints and distinguishing net external force from kinematic acceleration.'
      },
      {
        id: 'bc-phy-3',
        lectureId: 'lec-phy-101',
        ...
        explanation:
          'Comparison of inertial reference frame versus accelerating non-inertial reference frame illustrating origin of fictitious D\'Alembert pseudo-forces.'
      }
    ],
    audioTranscript: [
      {
...
- **Due Date**: Friday 5:00 PM IST.`
  ...
  // =========================================================================
  {
    ...
    duration: '45 mins',
    summary:
      'Detailed study of molecular geometries predicted by Valence Shell Electron Pair Repulsion (VSEPR) theory. Steric numbers, lone-pair distortions in ammonia and water, and orbital hybridization schemas (sp, sp², sp³).',
    topics: [
    ...
    generalizedNotes: {
      explanation:
        'VSEPR theory models molecular geometry based on electrostatic minimization between valence electron pairs. Steric number determines electron geometry, while the placement of lone pairs determines observable molecular shape.',
      importantConcepts: [
        {
...
- Determine Lewis structures, shapes, and hybridization for $\\text{PCl}_5, \\text{SF}_6, \\text{XeF}_4$. Due Tuesday.`
  ...
  // =========================================================================
  {
    ...
    duration: '45 mins',
    summary:
      'Rigorous exploration of limits, indeterminate forms, geometric proof of standard trigonometric limit lim(x->0) sin(x)/x = 1, and the Squeeze (Sandwich) Theorem for evaluating non-trivial limits.',
    topics: [
      'Definition of Limit',
      'Indeterminate Forms',
    ...
    generalizedNotes: {
      explanation:
        'Limits examine mathematical behavior arbitrarily close to a point. When substitution yields indeterminate ratios like 0/0, bounding theorems such as the Squeeze Theorem resolve the exact value.',
      importantConcepts: [
        {
...
export const seedBoardCaptures: BoardCapture[] = seedLectures.flatMap(l => l.boardCaptures || []);

// =========================================================================
// MASTERY QUIZZES INDEXED BY LECTURE ID
// =========================================================================
export const seedMasteryQuizzes: Record<string, LectureMasteryQuiz> = {
  'lec-phy-101': {
    id: 'quiz-phy-101',
    lectureId: 'lec-phy-101',
    lectureTitle: "Newton's Laws of Motion & Free Body Diagrams",
...
// =========================================================================
export const seedConceptMastery: Record<string, StudentConceptMastery[]> = {
  'student-g11-1': [
    {
...
// =========================================================================
export const seedStudentLectureProgress: Record<string, Record<string, any>> = {
  'student-g11-1': {
    'lec-phy-101': {
      lectureId: 'lec-phy-101',
      completed: false,
      ...
      lastMistakeReview: {
        ...
        correctAnswer:
          'Force is the interaction causing motion (measured in Newtons), while acceleration is the kinematic rate of change of velocity produced (in m/s²).',
        misconception:
          'Your answer treated force and acceleration as the same physical quantity. In lecture, Dr. Verma emphasized around 21:05 and 31:42 that Force is the cause, and acceleration is the effect.',
        timestampRef: '21:05'
      }
    }
  }
