...
export const FAKE_NOTES: StudentNote[] = [
  {
    id: 'note-phy-01',
    studentId: 'student-1',
    subjectId: 'subj-phy',
...
export const FAKE_QUESTION_BANKS: QuestionBank[] = [
  {
    id: 'qb-phy-01',
    subjectId: 'subj-phy',
...
export const FAKE_TIMELINES: TimelineItem[] = [
  {
    id: 'time-phy-1',
    subjectId: 'subj-phy',
...
export const FAKE_RESOURCES: ReferenceResource[] = [
  {
    id: 'res-phy-1',
    subjectId: 'subj-phy',
...
export const FAKE_ANALYTICS: Record<string, ClassAnalytics> = {
  'subj-phy': {
    subjectId: 'subj-phy',
    subjectName: 'Physics',
    totalStudents: 7,
