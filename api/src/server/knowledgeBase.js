...
exports.SUBJECT_KNOWLEDGE_BASE = void 0;
exports.synthesizeIntelligentAcademicResponse = synthesizeIntelligentAcademicResponse;
const conversationalEngine_1 = require("./conversationalEngine");
/**
 * Authentic, Exhaustive Subject Knowledge Base for Engineering University Courses
 */
exports.SUBJECT_KNOWLEDGE_BASE = {
    CPC: [
        {
 ...
 */
function synthesizeIntelligentAcademicResponse(query, subjectCode, subjectName, contextResources, subject, upcomingTimelines) {
...
What topic would you like to study?`,
    ...
    const subjectList = exports.SUBJECT_KNOWLEDGE_BASE[subjectCode] || [];
    // 2. Check for curated high-yield topic knowledge matches
    const matched = subjectList.find(item => item.topicMatchKeywords.some(keyword => cleanQuery.includes(keyword)));
    if (matched) {
    ...
    return (0, conversationalEngine_1.generateNaturalConversationalResponse)(query, subjectCode, subjectName, subject, upcomingTimelines, contextResources);
}
