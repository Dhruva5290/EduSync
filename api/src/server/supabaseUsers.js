...
exports.persistUserToCloud = persistUserToCloud;
exports.loadUsersFromCloud = loadUsersFromCloud;
exports.findUserInCloud = findUserInCloud;
exports.deleteUserFromCloud = deleteUserFromCloud;
...
function getClient() {
    ...
    if (!url || !key)
        return null;
    _sbClient = (0, supabase_js_1.createClient)(url, key);
    return _sbClient;
}
/**
...
async function findUserInCloud(loginId) {
    ...
    try {
        ...
        const matched = cloudUsers.find(u => (u.username && u.username.toLowerCase() === normalized) ||
