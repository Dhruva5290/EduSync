...
exports.generateNaturalConversationalResponse = generateNaturalConversationalResponse;
/**
 ...
 */
function generateNaturalConversationalResponse(userMessage, subjectCode, subjectName, subject, upcomingTimelines, contextResources) {
...
What topic or question is on your mind?`,
    ...
    // -------------------------------------------------------------
    if (clean.includes('time management') ||
...
💡 **Quick Exercise**: What is your biggest study challenge right now (e.g., getting started, staying focused, or exam anxiety)? I can tailor a specific routine for you!`,
    ...
    if (clean.includes('what are we studying') ||
